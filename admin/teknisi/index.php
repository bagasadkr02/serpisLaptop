                    ...
                    <table class="table table-striped table-sm">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Nomor Telepon Teknisi</th>
                        ...
                        <tbody>
                            ...
                            include '../../conn.php';
                            $no = 1;
                            $data = mysqli_query($mysqli, "select * from teknisi");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- Modal edit -->
                                        <div class="modal fade" id="staticBackdropEdit<?php echo $d['id_teknisi']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        include '../../conn.php';
                                                        $id = $d['id_teknisi'];
                                                        $query_edit  = mysqli_query($mysqli, "select * from teknisi where id_teknisi='$id'");
                                                            ...
                                                            <form method="post" action="update_action.php">
                                                                <table>
                                                                    <tr>
                                                                        <td>Nama teknisi</td>
                                                                        <td>
                                                                            <input type="hidden" name="id_teknisi" value="<?php echo $dEdit['id_teknisi']; ?>">
                                                                            <input type="text" name="nama" value="<?php echo $dEdit['nama']; ?>">
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Nomor telepon</td>
                                                                        <td>
                                                                            <input type="text" name="telp" value="<?php echo $dEdit['telp']; ?>">
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <div class="modal-footer">
                                        ...
                                        <a href="delete.php?id_teknisi=<?= $d['id_teknisi']; ?>" onclick="return confirm('Are you sure ?')">HAPUS</a>
